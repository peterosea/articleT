...
- search `<x-PostsRecommendation />` 텍스트 정렬수정
...
[v3.0.0 Milestone](https://github.com/beeclover/articleT/milestone/4)

## [v2.2.1] 2022-02-28

### Fixed

- github deploy action 테마폴더 위치 변경
...
- 최신 아티클 hashtag card template 해쉬태크 클래스 변경

## [v2.1.6] 2022-02-22

### Fixed

- hashtag taxonomy header # 누락
...
- archive content부분의 hashtag 클래스추가

## [v2.1.2] 2022-02-22

### Added

- hashtag inline 스타일 추가

## [v2.1.1] 2022-02-22

### Changed

- hashtag css before로 # 지정
