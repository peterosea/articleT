    ...
    <header id="header__top" class="header__top" :class="{'pr-[15px]': menuSelected === 'menu' || widget}">
      <div class="header__top-inner">
        ...
        <div class="listDivider__cols1 header__top-menu">
          <a class="header__top-menu-item hover:underline" href="https://www.talentbank.co.kr/client/project/projectRegStart" target="_blank" rel="noopener noreferrer">
            <svg class="i-crossbox" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="14px" height="14px" viewBox="0 0 14 14" enable-background="new 0 0 14 14" xml:space="preserve"><g><polygon fill="currentColor" points="6,3 5,3 5,6 2,6 2,7 5,7 5,10 6,10 6,7 9,7 9,6 6,6 	"></polygon><path fill="currentColor" d="M12,3h-1V2V1H0v1v9v1h2v1v1h1h10v-1V4V3H12z M1,11V2h9v1v1v7H1z M12,13H3v-1h8v-1V4h1V13z"></path></g></svg>
            <span>Project 무료의뢰</span>
          </a>
          <a class="header__top-menu-item" href="https://www.talentbank.co.kr/common/announceList" target="_blank" rel="noopener noreferrer">
            공지사항
          </a>
        </div>
      </div>
